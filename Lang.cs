...
<#= include('shared/model-class-begin.cs') #>
    ...
    public class Lang
    {
        ...
        [AllowNull]
        public static Dictionary<string, dynamic> Phrases;
        ...
        public Lang()
        {
            ...
            // Set up language id
            if (HttpContext != null && !Empty(Session[Config.SessionLanguageId])){
            ...
            <#if (ServerScriptExist("Global", "Language_Load")) { #>
...
#pragma warning restore 1998
        ...
        <#= GetServerEvent("Global", "Language_Load") #>
    }
